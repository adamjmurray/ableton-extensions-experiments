...
import { runStrumTests } from "../helpers.js";
  ...
  runStrumTests({
    start: [
      ...
      },
      {
        ...
        unlockEnd: true,
        edgeBehavior: "clamp",
        expected: [0, 0.375, 0.75, 1 - Note.MIN_DURATION, 1 - Note.MIN_DURATION],
      },
      {
        notes: [
          { pitch: 1, start: 0 },
      ...
      },
      {
        ...
        expected: [0, 0.75, 0.5, 0.25, 1 - Note.MIN_DURATION],
      },
      {
        notes: [
          { pitch: 1, start: 0 },
      ...
      },
      {
        ...
        unlockEnd: true,
        edgeBehavior: "rotate",
        expected: [0, 0.375, 0.75, 0.125, 0.5],
      },
      {
        notes: [
          { pitch: 1, start: 0 },

  ...
  runSlideTransformerTests("shift", {
    pitch: [
      ...
      },
      {
        ...
        description: "does not clamp to a max pitch (in the transformer)",
      },
      {
        input: [10, 11, 12, 13],
        edgeBehavior: "clamp",
        ...
        amount: -1,
        expected: [-2, -1, 0, 1],
        description: "does not clamp to a min pitch (in the transformer)",
      },
      {
        input: [10, 11, 12, 13],
    ...
    velocity: [
      ...
      },
      {
        ...
        amount: 1,
        expected: [126, 127, 128, 129],
        description: "does not clamp to a max velocity (in the transformer)",
      },
      {
        input: [10, 11, 12, 13],
        edgeBehavior: "clamp",
        ...
        amount: -1,
        expected: [-2, -1, 0, 1],
        description: "does not clamp to a min velocity (in the transformer)",
      },
      {
        input: [10, 11, 12, 13],
        edgeBehavior: "reflect",
      ...
      },
      {
        ...
        amount: 1,
        expected: [126, 127, 128, 129],
        description: "does not soft-delete notes with velocities above 127",
      },
      {
        input: [10, 11, 12, 13],
        edgeBehavior: "remove",
    ...
    start: [
      ...
      },
      {
        ...
        description: "reflects start times after clip end to the negative direction",
      },
      {
        input: [4, 5, 6, 7],
        clip: { start: 0, end: 8 },
    ...
    duration: [
      ...
      },
      {
        ...
        description: "wraps durations around from clip.length to 0 in the positive direction",
      },
      {
        input: [0.5, 1, 1.5],
        clip: { start: 2, end: 4 },
      ...
      },
      {
        ...
        description: "wraps durations around from 0 to clip.length in the negative direction",
      },
      {
        input: [1.5, 1, 0.5],
        clip: { start: 2, end: 4 },
      ...
      },
      {
        ...
        description: "reflects durations below 0 to the positive direction",
      },
      {
        input: [0.75, 1, 1.25, 2],
        clip: { start: 2, end: 4 },
      ...
      },
      {
        ...
        expected: [
          ...
          { duration: 0.00009999999999998899, deleted: true },
          Note.MIN_DURATION,
          1,
        ],
